Gem::Specification.new do |s|
  ...
  s.files       = Dir["{app}/***/**/*"] + ["lib/pyk.rb", "lib/pyk/address.rb", "lib/pyk/api.rb", "lib/pyk/date.rb", "lib/pyk/date_time.rb", "lib/pyk/dj.rb", "lib/pyk/float.rb", "lib/pyk/gravatar.rb", "lib/pyk/number.rb", "lib/pyk/regex.rb", "lib/pyk/spreadsheet.rb", "lib/pyk/string.rb", "lib/pyk/url.rb", "lib/pyk/user.rb", "lib/pyk/address_helpers.rb", "lib/pyk/app_helpers.rb", "lib/pyk/date_helpers.rb", "lib/pyk/devise_helpers.rb", "lib/pyk/number_helpers.rb", "lib/pyk/highcharts.rb"]
